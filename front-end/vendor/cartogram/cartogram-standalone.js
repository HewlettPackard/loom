...
function d3_geo_projectionRadians(stream) {
  ...
  d3.cartogram = function() {
    ...
    function carto(topology, geometries, points) {
      ...
      for (i1 = 0; i1 < projectedArcs.length; ++i1) {
        for (i2 = 0 ; i2 < projectedArcs[i1].length; ++i2) {
          extents.min = minV(projectedArcs[i1][i2], extents.min);
          extents.max = maxV(projectedArcs[i1][i2], extents.max);
        }
      }
    ...
    var minV = function(v1, v2) {
      return [Math.min(v1[0], v2[0]), Math.min(v1[1], v2[1])];
    };


    var maxV = function(v1, v2) {
  ...
  function object(arcs, o) {
    ...
    return o.type === "GeometryCollection" ? (o.geometries = o.geometries.map(geometry), o) : geometry(o);
  }
