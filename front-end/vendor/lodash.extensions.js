...
define(function (require) {
  ...
  _.dirty = function (f, thisArg) {
    ...
    var dirtyF = function () {
      if (thisArg._lodashcache[dirtyF.toString()]) {
        value = f.call(thisArg);
      }
      return value;
    };

    if (!thisArg._lodashcache) {
      thisArg._lodashcache = {};
    }

    thisArg._lodashcache[dirtyF.toString()] = false;

    return dirtyF;
  };

  _.setDirty = function (dirtyF, thisArg) {
    thisArg._lodashcache[dirtyF.toString()] = true;
  };
