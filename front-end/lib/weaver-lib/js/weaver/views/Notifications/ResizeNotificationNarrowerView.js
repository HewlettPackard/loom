...
define([], function () {
  ...
  var template = require('./screenNarrower.html');
   ...
   * @constructor
   */
  var ResizeNotificationNarrowerView = BaseView.extend({

    /**
     * @property constructorName
     * @type {String}
     * @default LOOM_ResizeNotificationNarrowerView
     * @final
     */
    constructorName: 'LOOM_ResizeNotificationNarrowerView',
  ...
  return ResizeNotificationNarrowerView;
});
