...
define(['lodash'], function (_) {
  ...
  /**
   * SideMenuSelectedInfoView displays information about the (un)/selected item in the side menu
   ...
   * @constructor
   */
  var SideMenuSelectedInfoView = BaseView.extend({
     ...
     * @type {String}
     */
    className: 'mas-sideMenuSelectedInfoView',
  ...
  return SideMenuSelectedInfoView;
});
