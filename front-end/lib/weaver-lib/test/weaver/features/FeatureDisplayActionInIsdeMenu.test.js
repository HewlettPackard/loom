...
], function (FeatureDisplayActionInSideMenu, EventBus) {
  "use strict";

  describe('weaver/features/FeatureDisplayActionInSideMenu.js', function () {
    beforeEach(function () {
      this.feature = FeatureDisplayActionInSideMenu;
