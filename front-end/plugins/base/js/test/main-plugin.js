...
function registerPlugin(p) { p(require); }

registerPlugin(function (require) {
  ...
  pluginAPI.registerDisplayMode({
    ...
    availability: function (thread) {
      return thread.get('geoAttributes') !== undefined;
    },
  ...
  var ccToEnNames = require('json!weaver-map/data/map-countrycodes-names_en.json');
...
registerPlugin(function (require) {
var ThreadTableView = require('weaver-table/views/ThreadTableView');
var pluginAPI = require('plugins/pluginAPI');
...
registerPlugin(function (require) {
var ThreadTreeMapView = require('weaver-treemap/views/ThreadTreeMapView');
var pluginAPI = require('plugins/pluginAPI');
