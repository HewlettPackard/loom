   ...
   interface ViewOptions<TModel extends Model> {
    ...
    class View<TModel extends Model> extends Events {
        ...
        **/
        ...
        attributes: any;
        $(selector: any): JQuery;
        render(): void; //View<TModel>;
        remove(): void; //View<TModel>;
        ...
        unstickit(optionalModel?: TModel, optionalSelector?: string | StickitSelector): void;
        addBinding(optionalModel: TModel, selector: string | StickitSelector, configuration?: string | Configuration): void;
    }
