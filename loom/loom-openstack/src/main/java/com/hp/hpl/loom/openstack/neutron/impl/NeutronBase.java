...
/**
 * Base class for the neutron API.
 *
 * @param <R> the type that this API returns.
 */
public abstract class NeutronBase<R extends Pagination, T> extends PagingBase<R, T> {
    private static final Log LOG = LogFactory.getLog(NeutronBase.class);
     ...
     */
    public NeutronBase(final OpenstackApi openstackApp, final JsonEndpoint jsonEndpoint) {
