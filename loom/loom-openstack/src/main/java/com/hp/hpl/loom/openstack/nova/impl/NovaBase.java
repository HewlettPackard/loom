 ...
 * @param <T>
 */
public abstract class NovaBase<R extends Pagination, T> extends PagingBase<R, T> {
    private static final Log LOG = LogFactory.getLog(NovaBase.class);
     ...
     */
    public NovaBase(final OpenstackApi openstackApp, final JsonEndpoint jsonEndpoint) {
