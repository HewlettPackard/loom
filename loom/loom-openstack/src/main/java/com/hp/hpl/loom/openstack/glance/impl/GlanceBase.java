...
/**
 * Base class for the glance API.
 *
 * @param <R> the type that this API returns.
 */
public abstract class GlanceBase<R extends Pagination, T> extends PagingBase<R, T> {
    private static final Log LOG = LogFactory.getLog(GlanceBase.class);
     ...
     */
    public GlanceBase(final OpenstackApi openstackApp, final JsonEndpoint jsonEndpoint) {
