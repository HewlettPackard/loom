...
@ItemTypeInfo(OsObjectType.TYPE_LOCAL_ID)
@ConnectedTo(toClass = OsContainer.class)
public class OsObject extends OsItem<OsObjectAttributes> {

    private OsObject() {
        super();
    }

    public OsObject(final String logicalId, final ItemType itemType) {
