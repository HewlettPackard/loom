...
@ItemTypeInfo(OsSubnetType.TYPE_LOCAL_ID)
...
public class OsSubnet extends OsItem<OsSubnetAttributes> {

    private OsSubnet() {
        super();
    }

    public OsSubnet(final String logicalId, final ItemType subnetType) {
        super(logicalId, subnetType);
    }
