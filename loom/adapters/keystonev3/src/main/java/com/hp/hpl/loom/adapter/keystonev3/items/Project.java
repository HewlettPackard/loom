...
@ItemTypeInfo(ProjectType.TYPE_LOCAL_ID)
@ConnectedTo(toClass = Domain.class)
@ConnectedTo(toClass = User.class)
@ConnectedTo(toClass = Role.class)
public class Project extends AdapterItem<ProjectItemAttributes> {

    public Project(final String logicalId, final ItemType itemType) {
