...
@Root
@ItemTypeInfo(DomainType.TYPE_LOCAL_ID)
@ConnectedTo(toClass = Project.class)
@ConnectedTo(toClass = User.class)
public class Domain extends AdapterItem<DomainItemAttributes> {

    public Domain(final String logicalId, final ItemType itemType) {
