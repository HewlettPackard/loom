...
public class ChefOrgType extends HpCloudItemType {
    public static final String TYPE_LOCAL_ID = "chef_org";
    public static final String[] PAYLOAD_FIELDS =
            {"name", "rev", "org_type", "full_name", "guid", "id", "clientname", "users"};
    private static final Log LOG = LogFactory.getLog(ChefOrgType.class);
    ...
    public ChefOrgType() {
        ...
        for (String attName : PAYLOAD_FIELDS) {
            try {
                ...
                LOG.error("Problem creating ChefOrgType", e);
            }
        }
    }
