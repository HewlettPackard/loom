...
public class ChefUploadedCookbookType extends HpCloudItemType {
    public static final String TYPE_LOCAL_ID = "chef_uploaded_cookbook";
    public static final String[] PAYLOAD_FIELDS = {"chef_org_guid", "chef_server", "versions", "name", "chef_org"};
    private static final Log LOG = LogFactory.getLog(ChefUploadedCookbookType.class);

    public ChefUploadedCookbookType() {
        super(TYPE_LOCAL_ID);
