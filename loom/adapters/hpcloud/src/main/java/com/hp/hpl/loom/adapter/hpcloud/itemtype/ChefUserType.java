...
public class ChefUserType extends HpCloudItemType {
    public static final String TYPE_LOCAL_ID = "chef_user";
    public static final String[] PAYLOAD_FIELDS = {"username", "orgs", "display_name", "id", "certificate"};
