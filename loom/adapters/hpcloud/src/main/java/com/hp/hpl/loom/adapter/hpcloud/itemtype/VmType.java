...
public class VmType extends HpCloudItemType {
    public static final String TYPE_LOCAL_ID = "vm";
    public static final String[] PAYLOAD_FIELDS = {"ref_datastore", "ipv4_address", "ipv6_address", "os_name",
            "addresses", "memoryMB", "numCPU", "numEthernetCards", "datacenterName", "ref_host", "version", "status",
            "address", "flavor", "disk", "vmname", "numVirtualDisks"};
