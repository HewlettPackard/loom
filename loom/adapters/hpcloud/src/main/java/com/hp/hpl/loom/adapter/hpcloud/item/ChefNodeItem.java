...
@ItemTypeInfo(ChefNodeType.TYPE_LOCAL_ID)
@ConnectedTo(toClass = ChefEnvironmentItem.class)
@ConnectedTo(toClass = ChefOrgItem.class)
public class ChefNodeItem extends HpCloudItem<ChefNodeItemAttributes> {

    public ChefNodeItem(final String logicalId, final ItemType type) {
        super(logicalId, type);
        // TODO Auto-generated constructor stub
    }

    public ChefNodeItem(final String logicalId, final ItemType type, final String name) {
        super(logicalId, type, name);
        // TODO Auto-generated constructor stub
    }

    public ChefNodeItem(final String logicalId, final ItemType type, final String name, final String description) {
        super(logicalId, type, name, description);
        // TODO Auto-generated constructor stub
    }

    // public ChefNodeItem(final String logicalId, final ItemType type, final String name, final
    // String description,
    // final String id) {
