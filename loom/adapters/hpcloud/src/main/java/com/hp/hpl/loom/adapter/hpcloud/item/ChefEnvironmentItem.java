...
@ItemTypeInfo(ChefEnvironmentType.TYPE_LOCAL_ID)
@ConnectedTo(toClass = ChefNodeItem.class)
@ConnectedTo(toClass = ChefOrgItem.class)
public class ChefEnvironmentItem extends HpCloudItem<ChefEnvironmentItemAttributes> {

    public ChefEnvironmentItem(final String logicalId, final ItemType type) {
        super(logicalId, type);
        // TODO Auto-generated constructor stub
    }

    public ChefEnvironmentItem(final String logicalId, final ItemType type, final String name) {
