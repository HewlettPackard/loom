...
@ItemTypeInfo(ChefUploadedCookbookType.TYPE_LOCAL_ID)
@ConnectedTo(toClass = ChefOrgItem.class)
public class ChefUploadedCookbookItem extends HpCloudItem<ChefUploadedCookbookItemAttributes> {

    public ChefUploadedCookbookItem(final String logicalId, final ItemType type) {
        super(logicalId, type);
        // TODO Auto-generated constructor stub
    }

    public ChefUploadedCookbookItem(final String logicalId, final ItemType type, final String name) {
    ...
    // public ChefUploadedCookbookItem(final String logicalId, final ItemType type, final String
    // name,
