...
public class ChefEnvironmentType extends HpCloudItemType {
    public static final String TYPE_LOCAL_ID = "chef_environment";
    public static final String[] PAYLOAD_FIELDS = {"chef_server", "description", "area", "area", "chef_org",
            "chef_org_guid", "cookbook_pins", "az", "continent", "name"};
    private static final Log LOG = LogFactory.getLog(ChefEnvironmentType.class);

    public ChefEnvironmentType() {
        super(TYPE_LOCAL_ID);
        ...
        for (String attName : PAYLOAD_FIELDS) {
            try {
                ...
                LOG.error("Problem creating ChefEnvironmentType", e);
            }
        }
    }
