...
public class FileItemAttributes extends CoreItemAttributes {
    ...
    @LoomAttribute(key = "Readonly", supportedOperations = {DefaultOperations.SORT_BY}, plottable = false,
            ...
            range = {@LiteralRange(key = "true", name = "True"), @LiteralRange(key = "false", name = "False")})
    ...
    @LoomAttribute(key = "latitude",
            supportedOperations = {DefaultOperations.SORT_BY, DefaultOperations.KMEANS,
                    ...
                    DefaultOperations.FILTER_BY_REGION},
            type = GeoAttribute.class, group = "latLong", latitude = true)
    ...
    @LoomAttribute(key = "longitude",
            supportedOperations = {DefaultOperations.SORT_BY, DefaultOperations.KMEANS,
                    DefaultOperations.POLYGON_CLUSTERING, DefaultOperations.GRID_CLUSTERING,
                    DefaultOperations.FILTER_BY_REGION},
            type = GeoAttribute.class, group = "latLong", longitude = true)
    private Double longitude;

    @LoomAttribute(key = "created", supportedOperations = {DefaultOperations.SORT_BY}, type = TimeAttribute.class,
            format = "MMM dd, YYYY", shortFormat = "MMM dd", plottable = true)
    private String created;

    @LoomAttribute(key = "updated", supportedOperations = {DefaultOperations.SORT_BY}, type = TimeAttribute.class,
            format = "MMM dd, YYYY", shortFormat = "MMM dd", plottable = true)
