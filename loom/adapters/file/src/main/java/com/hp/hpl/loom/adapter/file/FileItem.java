...
@ActionDefinition(id = "readonly", name = "Readonly", type = ActionTypes.Item, icon = "icon-readonly",
        ...
        parameters = {@ActionParameter(id = "readonly", name = "Confirmation",
                type = com.hp.hpl.loom.model.ActionParameter.Type.ENUMERATED,
                ranges = {@ActionRange(id = "no", name = "No"), @ActionRange(id = "yes", name = "Yes")})})
@ActionDefinition(id = "delete", name = "Delete", type = ActionTypes.Thread, icon = "icon-delete",
