...
@WebAppConfiguration
public class LoomServiceMvcConcurrentTest extends LoomServiceConcurrentTestBase {

    private static final Log LOG = LogFactory.getLog(LoomServiceMvcConcurrentTest.class);
