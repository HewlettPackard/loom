...
public class SimpleStitcherTest extends GenericStitcherTest {

    @Override
    protected StitcherRuleManager createNewStitcherRuleManager() {
        return new SimpleStitcherRuleManagerImpl();
    }

    @Override
    protected StitcherUpdater createNewStitcherSession(final StitcherRuleManager ruleManager) {
        return new SimpleStitcherSession((SimpleStitcherRuleManagerImpl) ruleManager);
    }
