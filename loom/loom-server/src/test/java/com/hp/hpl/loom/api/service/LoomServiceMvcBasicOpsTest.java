...
@WebAppConfiguration
public class LoomServiceMvcBasicOpsTest extends LoomServiceBasicOpsTestBase {
    private static final Log LOG = LogFactory.getLog(LoomServiceMvcBasicOpsTest.class);
