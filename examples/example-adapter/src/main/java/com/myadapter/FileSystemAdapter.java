...
public class FileSystemAdapter extends BaseAdapter {
    ...
    public Collection<PatternDefinition> getPatternDefinitions() {
        ...
        PatternDefinition patternDef =
                createPatternDefinitionWithSingleInputPerThread(TESTING_PATTERN, itemTypes, TESTING_PATTERN, null, true);

        List<ItemType> itemTypes2 = getItemTypesFromLocalIds(Arrays.asList(Types.DIR_TYPE_LOCAL_ID));
        PatternDefinition patternDef2 =
                createPatternDefinitionWithSingleInputPerThread(TESTING_PATTERN2, itemTypes2, TESTING_PATTERN2, null,
                        true);
    ...
    protected Provider createProvider(final String providerType, final String providerId, final String authEndpoint,
        ...
        return new com.hp.hpl.loom.model.ProviderImpl(providerType, providerId, authEndpoint, providerName, this.getClass().getPackage().getName().toString());
    }
    ...
    public Map<String, QuadFunctionMeta> registerQueryOperations(
        ...
        QueryOperation extractValue =
                new QueryOperation((inputs, params, errors, context) -> {
                    ...
                    // entry only
                        ...
                        try {
                            ...
                            errors.put(OperationErrorCode.NotReadableField,
                                    "attempted to fetch unaccessible property data.");
                        ...
                        // size_max
                        final float maxSize =
                                statMap.get(SeparableItem.CORE_NAME + "size" + SupportedStats.MAX.toString())
                                        .longValue() * 1F; // size_max
